...
# # Search similar images based on preferences and query image from db
# def search_similar_images(request, db, Images, Products):
#     # print()
#     # req_data = request.get_json(force=True)
#     # print('Request data: ', str(req_data))
#     # req_img_hash = req_data['img_hash']
#     # req_tags_positive = req_data['tags_positive'].strip('\'[]').split(',')
#     # req_tags_negative = req_data['tags_negative'].strip('\'[]').split(',')
#     # req_color = req_data['color'].strip('\'[]').split(',')  # RGB color array
#     # req_sex = req_data['sex']
#     # req_image_data = Images.query.filter_by(img_hash=req_img_hash).first()
#     # req_shop_excl = req_data['no_shop'].strip('\'[]').split(',')
#
...
#     req_color = request.args.get('color').strip('\'[]').split(',')  # RGB color array
...
#         conditions.append(
#             Images.img_cats_ai_txt.any(tag) | Images.img_cats_sc_txt.any(tag)
#         )
...
#                     req_color_norm = np.array(req_color, dtype=int) / np.sum(np.array(req_color, dtype=int))
...
#                     distance_color_1 = calc_distance(req_color_norm, query_color_1_norm) * 3
#                     distance_color_2 = calc_distance(req_color_norm, query_color_2_norm)
#                     distance_color_3 = calc_distance(req_color_norm, query_color_3_norm) / 3
#                     distance_color = distance_color_1 + distance_color_2 + distance_color_3
#                     print('Chi distance: ', str(distance_color))
#                     distance_color_euc_1 = int(
#                         spatial.distance.euclidean(np.array(req_color, dtype=int),
#                                                    np.array(query_result.color_1, dtype=int),
#                                                    w=None)) / 100
...
#         top_color_512_list = sorted_color_512_list[0:250]
#
...
#         top_encoding_list = sorted_encoding_list[0:150]
#
...
#         top_encoding_sqcrop_list = sorted_encoding_sqcrop_list[0:60]
#
