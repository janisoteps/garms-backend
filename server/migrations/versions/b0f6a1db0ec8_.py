...
Revision ID: b0f6a1db0ec8
Revises: 3fb88b83e043
Create Date: 2019-09-10 12:05:34.614585
...
revision = 'b0f6a1db0ec8'
down_revision = '3fb88b83e043'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index(op.f('ix_images_v2_img_name'), 'images_v2', ['img_name'], unique=False)
    op.create_index(op.f('ix_images_v2_kind_cats'), 'images_v2', ['kind_cats'], unique=False)
    op.create_index('name_idx_v2', 'images_v2', ['img_name'], unique=False, postgresql_ops={'img_name': 'gin_trgm_ops'}, postgresql_using='gin')
...
def downgrade():
    ...
    op.drop_index(op.f('ix_images_v2_img_name'), table_name='images_v2')
