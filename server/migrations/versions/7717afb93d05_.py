...
Revision ID: 7717afb93d05
Revises: c5a6148872fb
Create Date: 2020-01-29 14:38:11.352248
...
revision = '7717afb93d05'
down_revision = 'c5a6148872fb'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['img_hash'], ['images_skinny_women_a.img_hash'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('images_full_women_a_name_idx', 'images_full_women_a', ['img_full_name'], unique=False, postgresql_ops={'img_name': 'gin_trgm_ops'}, postgresql_using='gin')
    ...
    sa.Column('color_2', postgresql.ARRAY(sa.Integer()), nullable=True),
    sa.Column('color_3', postgresql.ARRAY(sa.Integer()), nullable=True),
    sa.ForeignKeyConstraint(['img_hash'], ['images_full_women_a.img_hash'], ),
    sa.PrimaryKeyConstraint('img_hash')
    )
    op.create_index('images_skinny_women_a_name_idx', 'images_skinny_women_a', ['img_skinny_name'], unique=False, postgresql_ops={'name': 'gin_trgm_ops'}, postgresql_using='gin')
