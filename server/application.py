...
def search_similar_infinite():
    ...
    if request.method == 'POST':
        ...
        search_results, search_cats, req_color = infinite_similar_images(request, db, req_img_full_db, req_img_skinny_db, req_prod_db)
        res = jsonify(res=search_results, cats=search_cats, color=req_color)
